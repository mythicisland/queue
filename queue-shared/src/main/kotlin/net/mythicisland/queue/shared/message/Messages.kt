...
val defaultMessages: Messages = mapOf(
    ...
    QueueStatus.WAITING_COUNTDOWN to ("<color:#22c55e>Found Match!</color> <color:#cbd5e1>Still waiting for players <queue_waiting_countdown_seconds>s (<queue_players>/<queue_max_capacity>)").toMiniFont(),
