...
val defaultMessages: Messages = mapOf(
    ...
    QueueStatus.WAITING_COUNTDOWN to "Waiting for players (<queue_players>/<queue_max_capacity>)",
    ...
    QueueStatus.TELEPORTING to "Teleporting to <server_group_name>-<server_numerical_id>...",
)